...
namespace TMPro.Examples
{
    ...
    public class TMP_TextSelector_B : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler, IPointerUpHandler
    {
        ...
        void RestoreCachedVertexAttributes(int index)
        {
            ...
            // UVS0
            src_uv0s = m_cachedMeshInfoVertexData[materialIndex].uvs0; // This line was already corrected by changing the declaration above.
            dst_uv0s = m_TextMeshPro.textInfo.meshInfo[materialIndex].uvs0; // This line was already corrected by changing the declaration above.
